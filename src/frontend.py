...
SQ_HEIGHT = 2
SQ_WIDTH = SQ_HEIGHT * 2 + int(SQ_HEIGHT / 2) #10
TOTAL_HEIGHT = 3 * SQ_HEIGHT #12 #P16
TOTAL_WIDTH = 3 * SQ_WIDTH #30 #P34
...
#middle face
color_list2 = [Colour.RED ,Colour.WHITE ,Colour.YELLOW ,
            Colour.BLUE ,Colour.YELLOW ,Colour.BLUE ,
            Colour.GREEN ,Colour.INDIGO ,Colour.GREEN] 

#middle bot face
color_list3 = [Colour.WHITE ,Colour.YELLOW ,Colour.INDIGO ,
            Colour.INDIGO ,Colour.WHITE ,Colour.GREEN ,
            Colour.GREEN ,Colour.BLUE ,Colour.RED]

#left face 
color_list4 = [Colour.RED ,Colour.YELLOW ,Colour.INDIGO ,
            Colour.INDIGO ,Colour.WHITE ,Colour.GREEN ,
            Colour.GREEN ,Colour.BLUE ,Colour.RED] 

#right face 
color_list5 = [Colour.WHITE ,Colour.YELLOW ,Colour.INDIGO ,
            Colour.INDIGO ,Colour.WHITE ,Colour.GREEN ,
            Colour.GREEN ,Colour.BLUE ,Colour.RED] 
...
def horizontal_grid_lines(face_colors):
    ...
    for h in range(0,len(width_indexes)):
        for num in range(0,len(width_indexes[h])):
            if width_indexes[h][num] > singe_face_vertical * 2 + 1 : #14 is for 4 tobechanged for height
                if (num != 0):
    ...
    for i in range(0,height_of_middle_view):
        ...
        print("|" , end="")
        before_middle_begins = int((number_of_spaces_before -3)) + 2 #44
        singe_face_vertical = int((number_of_spaces_before -3)/3)
